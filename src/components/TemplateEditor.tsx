        ...
        {activeTab === 'design' ? (
          <div className="space-y-6">
            ...
            <div className="space-y-3 border-t border-slate-800 pt-4">
              <label className="text-[10px] font-bold text-slate-500 uppercase">Custom Palette</label>
          ...
          <div className="space-y-4">
            {(Object.entries(config.elements) as [keyof CardConfig['elements'], any][]).map(([key, value]) => (
              <div key={key} className="space-y-3 p-3 bg-slate-900/40 rounded-xl border border-slate-800">
                <label className="text-[10px] font-black text-blue-400 uppercase tracking-widest block mb-2">{key} control</label>
                <div className="space-y-4">
                  {[
