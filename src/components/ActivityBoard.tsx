            ...
            <motion.div
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    key={idx}
                    className="flex flex-col items-center justify-center p-4 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-xl transition-all group active:scale-95">
                    <span
              ...
              <div className="flex-1 bg-slate-900/50 rounded-xl border border-slate-800 p-4 relative overflow-hidden flex flex-col">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-[9px] bg-blue-600/20 text-blue-400 px-2 py-0.5 rounded border border-blue-600/30 font-black">
                    2 RUNNING
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      name: "Batch Export #120",
                      progress: 85,
                      status: "Processing",
                    },
                    {
                      name: "Asset Pre-compilation",
                      progress: 42,
                      status: "Queued",
                    },
                  ].map((job, i) => (
                    <div key={i} className="space-y-1.5">
                      ...
                      <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden">
                        <progress
                          className="field-range h-1 w-full"
                          value={job.progress}
                          max={100}
                        />
                      </div>
                  ...
                  <tbody className="divide-y divide-slate-800/50">
                    {[
                      ...
                      <tr
                        ...
                        <td className="py-2 px-2 text-slate-300 font-bold">
                          {row.op}
                        </td>
