...
import { UserCircle, Briefcase, Hash, Calendar, Upload, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto pr-1 custom-scrollbar space-y-5">
        ...
        <div className="space-y-3">
          ...
          <div className="relative group">
            <div className={`w-full aspect-square md:aspect-video rounded-xl border-2 border-dashed transition-all flex flex-col items-center justify-center gap-3 ${data.imageUrl ? 'border-blue-500/50 bg-blue-500/5' : 'border-slate-800 bg-slate-900/50 hover:border-slate-700'}`}>
              {data.imageUrl ? (
                <div className="relative w-full h-full flex items-center justify-center p-4">
                  <img src={data.imageUrl} alt="Preview" className="max-h-full rounded-lg shadow-lg" />
                  <button 
                ...
                <>
                  ...
                  <div className="text-center">
                    <p className="text-xs font-bold text-slate-300">Drop profile image here</p>
